export default function Gym() {
  return (
    ...
    >
      ...
      />
      <path
        d="M3.33325 39.05V24.95C3.33325 24.4253 3.75858 24 4.28325 24H10.3833C10.9079 24 11.3333 24.4253 11.3333 24.95V39.05C11.3333 39.5747 10.9079 40 10.3833 40H4.28325C3.75858 40 3.33325 39.5747 3.33325 39.05Z"
        stroke="white"
        stroke-width="2"
        stroke-linecap="round"
        stroke-linejoin="round"
