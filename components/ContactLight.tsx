        ...
        >
          ...
          {field.type === "textarea" ? (
            <textarea
              ...
              className="appearance-none bg-transparent min-h-[30px] h-auto text-xl lg:text-2xl font-clash resize-none py-2 md:py-5 w-full placeholder-primary placeholder-opacity-40 !outline-none col-span-2"
            ...
            <input
              ...
              required={field.required}
              placeholder={field.placeholder}
              className="appearance-none text-xl lg:text-2xl font-clash bg-transparent py-2 md:py-5 w-full placeholder-primary placeholder-opacity-40 !outline-none"
              onChange={handleInputChange}
            />
          )}
        </div>
